              ...
              SizedBox(
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final isSelected =
                        (materialProvider.selectedSubject ?? 'All') == subject;
                    return SubjectChip(
                      label: subject,
                      isSelected: isSelected,
                      onTap: () {
                        materialProvider.setSubjectFilter(
                ...
                child: materialProvider.isLoading &&
                    ...
                    : materialProvider.materials.isEmpty
                        ...
                        : RefreshIndicator(
                            ...
                            onRefresh: () =>
                                materialProvider.fetchMaterials(refresh: true),
                            child: ListView.builder(
                              controller: _scrollController,
                              padding: const EdgeInsets.only(top: 4, bottom: 100),
                              itemCount: materialProvider.materials.length +
                                  (materialProvider.hasMore ? 1 : 0),
                              itemBuilder: (context, index) {
                                if (index >=
                                ...
                                final material =
                                    materialProvider.materials[index];
                                return MaterialCard(
                                  material: material,
                                  onTap: () {
